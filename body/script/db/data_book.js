const livros = [
   ...
   },
   {
      ...
      titulo: "It a Coisa",
      autor: "Stephen King",
      link: "1BuAXcHaKDDB_J1g9AgJyJdmxaIMHKYKo",
      capa: "1R5Vh6eF31kPXjUo7NiYYmJ5vZ0qs6GCK",
      descricao: "Um grupo de amigos enfrenta uma entidade maligna que se alimenta do medo, simbolizada pelo palhaço Pennywise. O livro mistura terror e amizade, mostrando como traumas da infância permanecem na vida adulta.",
      genero: "terror"
   },
   {
      id: 8,
      ...
      link: "15vvAEd5xM_oxuhbxYhb4b-Wql3IGYdum",
      capa: "1Wh3JMTr0nhWlYVMOPZ23bPa88NVv3q1G",
      descricao: "Um piloto conhece um pequeno príncipe que viaja por planetas e ensina lições sobre amizade, amor e o que realmente importa na vida.",
      genero: "fantasia"
   },
   {
      id: 9,
   ...
   {
      id: 10,
      titulo: "Leia um Café, Tome uma Poesia",
      autor: "Autor não especificado",
      link: "16dTWzSC6V5h9O_N7eenNilcLwT-0wC0S",
      capa: "19ArafF8GsMw4i-VfGN8RSmQ5K0I4ji2N",
      descricao: "Livro de poesias que convida à reflexão e apreciação da vida através das palavras.",
      genero: "poesia"
   },
   {
      id: 11,
   ...
   },
   {
      ...
      link: "1DRMmbZMi7mbiWAj_9yqHFo5Ay0rxCFJ_",
      capa: "1B1crfhPbvreMt_CctbrhDq0ahPd1Cfxw",
      descricao: "Primeiro livro da saga que narra o romance entre Bella Swan, uma humana, e Edward Cullen, um vampiro, explorando temas de amor, identidade e escolhas difíceis em um mundo sobrenatural.",
      genero: "fantasia"
   }
];